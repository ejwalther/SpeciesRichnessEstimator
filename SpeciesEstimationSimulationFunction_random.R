#-----------------------------------------------------------------------------------
#        Function for Simulating Sample Data sets from a single area
#       
...
#     2. Species abundance distributions are log-normally distributed within functional groups
#     3. An individual is randomly drawn from the regional species 
...
#                     representation n regional species pool (!=1). Default==2
